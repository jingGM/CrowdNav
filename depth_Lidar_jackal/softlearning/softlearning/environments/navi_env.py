...
class navi_env(metaclass=ABCMeta):
	'''
    ...
    def __init__(self, num_agents=1, num_obstacles=5,agent_radius=0.12, env_size=4.0,max_vx=0.3, key=42, options=2):
    ...
    def _update_stage(self):
        ...
        self.starts, self.goals, self.waypoints = self.scenarios.random_empty()
        ...
        for s, g, wps in zip(self.starts, self.goals, self.waypoints):
            ...
            state_msg.model_name = "jackal%d"%i
