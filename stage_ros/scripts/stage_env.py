...
from stage_ros.srv import UpdateStage, UpdateStageRequest
from stage_ros.msg import Action, Actions, States, Transitions
...
class StageEnv(object):
    ...
    def __init__(self, num_agents=5, num_obstacles=0,agent_radius=0.12, env_size=4.0,max_vx=1.0, key=42, options=2):
...
#----------------------------------------------------------------------
        ...
        self.update_stage_srv = rospy.ServiceProxy(
            "/update_positions", UpdateStage)
...
#=======================================================================================
    ...
    def _update_stage(self):
        ...
        for s, g in zip(self.starts, self.goals):
            ...
            goal.x = g[0]
            goal.y = g[1]
            request.points.append(goal)
        # print("starts: ", self.starts)
        # print("goals: ", self.goals)
        resp = self.update_stage_srv(request)
        time.sleep(2.5)
        return resp.success
