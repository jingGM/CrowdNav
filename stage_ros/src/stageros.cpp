...
//#include <stage_ros/UpdateRobotsPose.h>
...
//#include "transition_generated.h"
// Our node
class StageNode
{
private:
...
public:
    ...
    //bool cb_update_srv(stage_ros::UpdateRobotsPoseRequest& request, stage_ros::UpdateRobotsPoseResponse& response);
...
//StageNode::cb_update_srv(stage_ros::UpdateRobotsPoseRequest& request, stage_ros::UpdateRobotsPoseResponse& response)
{
...
StageNode::WorldCallback()
{
    ...
    rs.robot_num = this->robotmodels_.size();
