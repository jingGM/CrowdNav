        ...
        if len(x) > 1:
            ...
            for i in range(len(x)):  # for each agent
                if self.obstype == "scan":
                    ...
                    # image_now_testing = np.array(image_now)
                    # print(image_now_testing.shape)
                    # image_p1_testing = np.array(image_p1rev)
                    # print(image_p1_testing.shape)
                    # image_p2_testing = np.array(image_p2rev)
                    # print(image_p2_testing.shape)
            ...
            if self.obstype == "scan":
                ...
                # image_now_testing = np.array(x[0].image_now)
                # print(image_now_testing.shape)
                # image_p1_testing = np.array(x[0].image_p1rev)
                # print(image_p1_testing.shape)
                # image_p2_testing = np.array(x[0].image_p2rev)
                # print(image_p2_testing.shape)
                try:
