        ...
        if len(x) > 1:
            ...
            for i in range(len(x)):  # for each agent
                if self.obstype == "scan":
                    ...
                    image_now = np.amin(image_now, axis = 0)
                    # print(image_now)
                    # print("Shape of image_now = {}".format(image_now.shape))
                    ...
                    image_p1rev = np.amin(image_p1rev, axis = 0)
                    # print(image_p1rev)
                    # print("Shape of image_p1rev = {}".format(image_p1rev.shape))
                    ...
                    image_p2rev = np.amin(image_p2rev, axis = 0)
                    # print(image_p2rev)
                    # print("Shape of image_p2rev = {}".format(image_p2rev.shape))
