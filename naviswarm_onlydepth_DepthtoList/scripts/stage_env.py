...
class StageEnv(object):
    ...
    def __init__(self, num_agents=10, num_obstacles=5,
        ...
        self.image_space = spaces.Box(low=0., high=5, shape=(120,150,1,)) 
    ...
    def _add_marker(self,markerType,color,scale,pose=None,ns=None,text=None,points=None):
        ...
        if ns == "usv":
            ...
            marker.mesh_resource = "file:///home/jingl/Documents/catkin_ws/src/naviswarm_onlydepth_v2/rviz/usv.dae"
            marker.id = self.agent_markers_id
            self.agent_markers.markers.append(marker)
            self.agent_markers_id += 1
